...
export default function LoginButton() {
  ...
  const signInButtonClasses = `${commonButtonClasses} bg-slate-700 text-white hover:bg-slate-600 dark:bg-purple-600 dark:hover:bg-purple-500 focus:ring-slate-500 dark:focus:ring-purple-400`;
  const signOutButtonClasses = `${commonButtonClasses} bg-slate-200 text-slate-700 hover:bg-slate-300 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-slate-600 focus:ring-slate-400 dark:focus:ring-slate-500`;
    ...
    return (
      <div className="flex items-center space-x-3">
        ...
        <div className="text-sm">
          <p className="font-medium text-slate-700 dark:text-slate-200 truncate max-w-[150px] md:max-w-[200px]">
